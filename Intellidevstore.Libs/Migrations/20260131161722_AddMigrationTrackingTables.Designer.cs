...
namespace Intellidevstore.Libs.Migrations
{
    ...
    [Migration("20260131161722_AddMigrationTrackingTables")]
    partial class AddMigrationTrackingTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Intellidevstore.Libs.Database.Entities.MigrationLock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasKey("Id")
                        .HasName("pk_migration_locks");

                    b.HasIndex("ExpiresAt")
                        .HasDatabaseName("ix_migration_locks_expires_at");

                    b.HasIndex("LockId")
                        .HasDatabaseName("ix_migration_locks_lock_id");

                    b.HasIndex("LockName")
                        .IsUnique()
                        .HasDatabaseName("ix_migration_locks_lock_name");

                    b.ToTable("migration_locks", (string)null);
                });

            modelBuilder.Entity("Intellidevstore.Libs.Database.Entities.MigrationRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("AppliedAt")
                        .HasDatabaseName("ix_migration_records_applied_at");

                    b.HasIndex("IsSuccess")
                        .HasDatabaseName("ix_migration_records_is_success");
